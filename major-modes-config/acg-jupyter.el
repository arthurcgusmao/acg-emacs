...
;;     ;; if paragraph inside defun, mark defun
;;     )
;;   )

;; Keybindings
(define-key jupyter-repl-interaction-mode-map (kbd "C-c C-c") 'acg/jupyter-eval-paragraph-or-region)
(define-key jupyter-repl-interaction-mode-map (kbd "C-c C-l") 'jupyter-eval-line-or-region)
