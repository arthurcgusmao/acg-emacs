(custom-set-faces
 ...
 '(org-level-1 ((t (:inherit outline-1 :background "#EDF" :foreground "#408" :weight bold :height 1.60))))
 '(org-level-2 ((t (:inherit outline-2 :background "#FDE" :foreground "#804" :weight bold :height 1.40))))
 '(org-level-3 ((t (:inherit outline-3 :background "#EFD" :foreground "#480" :weight bold :height 1.20))))
 '(org-level-4 ((t (:inherit outline-4 :background "#FED" :foreground "#840" :weight bold :height 1.10))))
 '(org-level-5 ((t (:inherit outline-5 :background "#DEF" :foreground "#048" :weight bold :height 1.05))))
 '(org-level-6 ((t (:inherit outline-6 :background "#DFE" :foreground "#084" :weight bold :height 1.00))))
 '(org-level-7 ((t (:inherit outline-7 :background "#EDF" :foreground "#408" :weight bold :height 1.00))))
 '(org-level-8 ((t (:inherit outline-8 :background "#FDE" :foreground "#804" :weight bold :height 1.00))))
